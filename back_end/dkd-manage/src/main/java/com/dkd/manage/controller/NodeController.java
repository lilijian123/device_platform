...
public class NodeController extends BaseController
{
    ...
    @Log(title = "广告点位管理", businessType = BusinessType.EXPORT)
    @PostMapping("/export")
    public void export(HttpServletResponse response, Node node)
    {
        ...
        util.exportExcel(response, list, "广告点位管理数据");
    }
    ...
    @Log(title = "广告点位管理", businessType = BusinessType.INSERT)
    @PostMapping
    ...
    @Log(title = "广告点位管理", businessType = BusinessType.UPDATE)
    @PutMapping
    ...
    @Log(title = "广告点位管理", businessType = BusinessType.DELETE)
	@DeleteMapping("/{ids}")
